...
interface LoginType {
    ...
    children: ReactNode;
    index?: number;
    callback: (e: object, path?:string) => void;
    dataType?: string
}

export const Login: FC<LoginType> = ({ children, callback, dataType, index, formConfig, isNeedRemeber }) => {
    const [form] = Form.useForm();
    const { buttonText, mode, actionImpl, onFinish, loading, LoginToRegisterImpl } = useLoginAndRegister(isNeedRemeber, callback);
    useEffect(() => {

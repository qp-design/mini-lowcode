        ...
        tableConfig: [
            ...
            },
            {
                ...
                render(items = []) {
                    ...
                    return (_jsx(_Fragment, { children: items.map((item) => (_jsxs(Space, { children: [_jsx("img", { src: item.dataPic, width: 40 }), _jsxs("div", { children: [_jsx("p", { children: item.goodsName }), _jsxs("p", { children: [item.contractGoodsPrice, " X ", item.goodsNum] })] })] }))) }));
                }
            },
            // {
            //   title: '商品信息',
